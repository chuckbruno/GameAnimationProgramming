...
{
    return mat4(
        M4D(0, 0), M4D(1, 0), M4D(2, 0), M4D(3, 0), // Column 1
        M4D(0, 1), M4D(1, 1), M4D(2, 1), M4D(3, 1), // Column 2
        M4D(0, 2), M4D(1, 2), M4D(2, 2), M4D(3, 2), // Column 3
        M4D(0, 3), M4D(1, 3), M4D(2, 3), M4D(3, 3)  // Column 4
    );
}
...
mat4 adjugate(const mat4& m)
{
    ...
    cofactor.v[6] = -M4_3X3MINOR(0, 2, 3, 0, 1, 2);
...
{
    float ymax = znear * tanf(fov * 3.1415926f / 360.0f);
